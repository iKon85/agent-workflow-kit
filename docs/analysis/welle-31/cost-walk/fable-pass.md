...
| 6 | `land-planning-output`'s `no-release-coupling` prose | **move** into `wrapup` | The coupling it warns about is resolved (F6); this slice lands 8 files with no bump | The historical record of why the Content route exists. |

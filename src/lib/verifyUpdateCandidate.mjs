...
export async function verifyCandidateMetadata(candidateRoot, context) {
  ...
  for (const entry of installable) {
    ...
    // A Kit-origin candidate path carries the package bytes and mode, with no
    // local-snapshot exemption: an undeclared Consumer edit is overwritten, and
    // only a ledger-declared Consumer origin keeps its own identity.

...
**Hoher Einsatz / schwer reversibel** (Auth, Schema, Concurrency, Migrations, Payments)? → zusätzlich `grill-with-docs-codex` — derselbe Grill plus Cross-Model-Review durch Codex danach (Claude-Code-Surface).
<!-- mirror-xform:end -->
